class ServiciosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to servicios_path, status: :see_other, notice: "Servicio was successfully destroyed." }
  ...
  private
    ...
    def servicio_params
      params.require(:servicio).permit(:codigo_servicio, :nombre, :descripcion, :costo_base, :laboratorista_id)
    end
end
