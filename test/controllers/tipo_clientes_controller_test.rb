...
class TipoClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_cliente" do
    assert_difference("TipoCliente.count") do
      post tipo_clientes_url, params: { tipo_cliente: { descripcion: @tipo_cliente.descripcion, nombre: @tipo_cliente.nombre } }
    end
  ...
  test "should update tipo_cliente" do
    patch tipo_cliente_url(@tipo_cliente), params: { tipo_cliente: { descripcion: @tipo_cliente.descripcion, nombre: @tipo_cliente.nombre } }
