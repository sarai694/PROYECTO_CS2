...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference("Servicio.count") do
      post servicios_url, params: { servicio: { codigo_servicio: @servicio.codigo_servicio, costo_base: @servicio.costo_base, descripcion: @servicio.descripcion, laboratorista_id: @servicio.laboratorista_id, nombre: @servicio.nombre } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { codigo_servicio: @servicio.codigo_servicio, costo_base: @servicio.costo_base, descripcion: @servicio.descripcion, laboratorista_id: @servicio.laboratorista_id, nombre: @servicio.nombre } }
